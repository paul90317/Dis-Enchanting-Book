...
data modify entity @e[type=item,nbt={Item:{id:"minecraft:enchanted_book",tag:{StoredEnchantments:[]}}},sort=nearest,limit=1] Item.tag.StoredEnchantments append from entity @s Item.tag.Enchantments[0]
